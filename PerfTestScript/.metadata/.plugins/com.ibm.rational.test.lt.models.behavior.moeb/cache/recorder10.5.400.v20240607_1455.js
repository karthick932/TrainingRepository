...
DomainManager.prototype={
		...
		getProxy: function(element){
			...
			if ((typeof element.registeredClassName === "undefined") || element.registeredClassName != element.className
					|| element.registeredDomain != this.registeredDomains.length || (typeof element.registeredClassName != "undefined" 
...
HtmlElementProxy.prototype.applyDecoratedProps = function (targetElement) {
	...
	targetElement.exist = this.getProperty(WebGuiConstants.EXIST_PROP);
};
...
HtmlElementProxy.prototype.getProperty = function(propName) {
	var propValue = "";
	if (propName && propName.toLowerCase() == WebGuiConstants.TAGNAME_PROP.toLowerCase()) {
...
var postXHRThroughCustomEventFlag = true;
